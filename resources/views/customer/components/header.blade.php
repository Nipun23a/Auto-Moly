                            ...
                            <div class="bottom d-flex align-items-center justify-content-between">
                                <div class="nav-area">
                                    <ul class="">
                                        ...
                                        <li class="main-nav">
                                            <a class="main-menu" href="{{ Auth::check() ? 'scanner' : route('login') }}">Scanner</a>
                                        </li>
                                        <li class="main-nav">
                                ...
                                <div class="bottom-right">
                                    <div class="button-area">
                                        <!-- Conditionally display Sign In / Sign Out -->
                                        <a href="{{ Auth::check() ? '#' : route('login') }}" class="rts-btn btn-border radius-small icon"
                                           @if(Auth::check())
                                               onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                                            @endif>
                                            {{ Auth::check() ? 'Sign Out' : 'Sign In' }}
                                        ...
                                        <a href="{{ Auth::check() ? '#' : route('login') }}" class="rts-btn btn-primary radius-small icon">
                                            @if(auth()->check())
                                                Dashboard
                                            @else
                                                Add Car
